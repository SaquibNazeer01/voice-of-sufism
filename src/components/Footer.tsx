...
export const Footer: React.FC<FooterProps> = ({ onSelectTab, onOpenAdminLogin }) => {
  ...
  const socials = [
    { label: 'Facebook',  href: 'https://www.facebook.com/VoiceOfSufism',     icon: FacebookIcon,  color: 'hover:text-blue-400' },
    { label: 'Instagram', href: 'https://www.instagram.com/voiceofsufism',    icon: InstagramIcon, color: 'hover:text-pink-400'  },
    { label: 'YouTube',   href: 'https://www.youtube.com/@VoiceOfSufism',     icon: YouTubeIcon,   color: 'hover:text-red-400'   },
    ...
    <footer className="bg-[#07070A] text-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10">
        ...
        <div className="space-y-4">
          ...
          <p className="font-ui text-[13px] text-slate-400 leading-relaxed">
            Founded by <span className="text-white font-semibold">Sahil Amin</span> to preserve Kashmir's Sufi cultural identity for future generations.
          </p>
          <p className="font-ui text-[13px] text-slate-400 leading-relaxed">
