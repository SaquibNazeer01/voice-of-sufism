...
export const HeroSection: React.FC<HeroSectionProps> = ({
  ...
  const email = 'mohmmadaminbhat1@gmail.com';
  ...
  return (
    <section className="bg-[#FAF8F5]">
      ...
      {/* ══════════════════════════════════════════════
          ...
          Vibrant, colourful branded pills below the banner
      ══════════════════════════════════════════════ */}
      <div className="bg-[#070709] border-b border-white/[0.08] shadow-inner">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-3 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
          ...
          <a
            ...
            className="group flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-red-950/40 hover:bg-red-600 text-red-200 hover:text-white border border-red-500/40 hover:border-red-500 text-[11px] font-ui font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-red-600/30"
          >
            <span className="w-5 h-5 rounded-full bg-red-600 text-white flex items-center justify-center shadow-xs group-hover:bg-white group-hover:text-red-600 transition-colors">
              <YouTubeIcon />
            </span>
            <span>YouTube</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-pink-950/40 hover:bg-gradient-to-r hover:from-[#833ab4] hover:via-[#fd1d1d] hover:to-[#fcb045] text-pink-200 hover:text-white border border-pink-500/40 hover:border-pink-400 text-[11px] font-ui font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-pink-500/30"
          >
            <span className="w-5 h-5 rounded-full bg-gradient-to-tr from-[#f09433] via-[#dc2743] to-[#bc1888] text-white flex items-center justify-center shadow-xs group-hover:scale-110 transition-transform">
              <InstagramIcon />
            </span>
            <span>Instagram</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-blue-950/40 hover:bg-[#1877F2] text-blue-200 hover:text-white border border-blue-500/40 hover:border-blue-400 text-[11px] font-ui font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-600/30"
          >
            <span className="w-5 h-5 rounded-full bg-[#1877F2] text-white flex items-center justify-center shadow-xs group-hover:bg-white group-hover:text-[#1877F2] transition-colors">
              <FacebookIcon />
            </span>
            <span>Facebook</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-rose-950/40 hover:bg-[#E60023] text-rose-200 hover:text-white border border-[#E60023]/40 hover:border-[#E60023] text-[11px] font-ui font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-[#E60023]/30"
          >
            <span className="w-5 h-5 rounded-full bg-[#E60023] text-white flex items-center justify-center shadow-xs group-hover:bg-white group-hover:text-[#E60023] transition-colors">
              <PinterestIcon />
            </span>
            <span>Pinterest</span>
          </a>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="group flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-emerald-950/40 hover:bg-[#25D366] text-emerald-200 hover:text-slate-950 border border-emerald-500/40 hover:border-emerald-400 text-[11px] font-ui font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-emerald-500/30"
          >
            <span className="w-5 h-5 rounded-full bg-[#25D366] text-white flex items-center justify-center shadow-xs group-hover:bg-slate-950 group-hover:text-[#25D366] transition-colors">
              <WhatsAppIcon />
            </span>
          ...
          <a
            href={phoneUrl}
            className="group flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-sky-950/40 hover:bg-sky-500 text-sky-200 hover:text-slate-950 border border-sky-500/40 hover:border-sky-400 text-[11px] font-ui font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-sky-500/30"
          >
            <span className="w-5 h-5 rounded-full bg-sky-500 text-white flex items-center justify-center shadow-xs group-hover:bg-slate-950 group-hover:text-sky-400 transition-colors">
          ...
          <a
            href={emailUrl}
            className="group flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-amber-950/40 hover:bg-amber-400 text-amber-200 hover:text-slate-950 border border-amber-500/40 hover:border-amber-400 text-[11px] font-ui font-semibold transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-amber-500/30"
          >
            <span className="w-5 h-5 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 text-slate-950 flex items-center justify-center shadow-xs">
              <Mail className="w-3 h-3 text-slate-950" />
            </span>
            <span className="hidden sm:inline">mohmmadaminbhat1@gmail.com</span>
